	...
	return (
		<div>
			<span className='flex items-center'>
				...
				<a className='flex' href='https://github.com/not-ivy'>not-ivy<HiExternalLink /></a>
			</span>
			<span className='flex items-center'>
				<div className='m-4'><HiKey size={30} /></div>
				<a className='flex' href='https://keys.openpgp.org/vks/v1/by-fingerprint/2377F28C8BDC3BB7CDE8337CD2A1D05E1B5EAA32'>2377F28C8BDC3BB7CDE8337CD2A1D05E1B5EAA32 <HiExternalLink /></a>
			</span>
			<span className='flex items-center'>
				<div className='m-4'><HiMail size={30} /></div>
				<a className='flex' href='mailto:ivy@not-ivy.dev'>ivy@not-ivy.dev<HiExternalLink /></a>
			</span>
			<span className='flex items-center'>
