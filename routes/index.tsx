...
export default function Home() {
  return (
    <>
      ...
      <div class="p-10 mx-auto max-w-screen-sm">
        <img
          src="https://avatars.githubusercontent.com/u/47074495"
          class="w-24 h-auto rounded-full mx-auto mb-2"
        />
        <h1 class="text-center text-xl font-medium">ivymkii</h1>
        ...
        <p class="text-center">
          ...
          libraries such as SolidJS, and Preact, as well as their
          metaframeworks. I also have some experience with Rust, Kotlin, Java,
          and shell scripting.
        </p>
        <div class="flex justify-center items-center mt-4">
          <a
            class="cursor-pointer px-3 py-2 bg-white rounded hover:bg-gray-200 border border-gray-300 transition-colors flex items-center gap-x-2"
            href="/projects"
          >
