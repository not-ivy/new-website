    ...
    <>
      ...
      <main class="p-10 mx-auto max-w-screen-sm">
        ...
        <div class="flex justify-center items-center mt-4 gap-x-16">
          <a
            class="cursor-pointer px-3 py-2 bg-white rounded hover:bg-gray-200 border border-gray-300 transition-colors flex items-center justify-center gap-x-4 select-none w-full"
            href="/projects"
          >
